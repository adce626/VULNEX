...
export default function CRLFPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageTitle title="CRLF Injection" />
      <MainSidebar />
      ...
      <main className="lg:pl-64">
        ...
        <div className="border-b border-border bg-card/50">
          <div className="mx-auto max-w-5xl px-6 py-3">
            <nav className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-foreground">CRLF Injection</span>
            </nav>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden border-b border-border bg-gradient-to-br from-primary/10 via-background to-accent/5">
          <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-50" />
        ...
        <div className="mx-auto max-w-5xl space-y-12 p-6">
          {crlfCategories.map((category, idx) => {
            ...
            return (
              <section key={idx} id={sectionId} className="scroll-mt-20">
                ...
                <CommandList commands={category.commands} pageTitle="CRLF Injection" pageSize={15} domain={domain} />
              </section>
            )
          })}
