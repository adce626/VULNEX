...
import {
  googleAPIKeysCategories,
  googleAPIKeysTools,
} from "@/lib/google-api-keys-data"
import {
  Key,
  Terminal,
  ChevronRight,
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="lg:pl-64">
        ...
        <div className="relative overflow-hidden border-b border-border bg-gradient-to-br from-primary/10 via-background to-accent/5">
          <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNjAiIGhlaWdodD0iNjAiIHBhdHRlcm4IGlkPSJncmlkIiB3aWR0aD0iNjAiIGZpbGw9Im5vbmUiIHN0cm9rZT0icmRhdPSJNIDYwIDAgTCBMMCAwIDAgNjAiIGZmlsbD0ibm9uZSIgd2lkdGg9IjEwMCUiIGhlaWdodD0iMTAwJSIgZXh0PSJ3Ii8+PC9zdmc+')] opacity-50" />
        ...
        <div className="sticky top-0 z-20 border-b border-border bg-card/95 backdrop-blur-sm">
          <div className="mx-auto max-w-5xl px-6">
            <div className="flex gap-1 overflow-x-auto py-3 scrollbar-hide">
              {googleAPIKeysCategories.map((cat) => {
        ...
        <div className="mx-auto max-w-5xl space-y-12 p-6">
          {googleAPIKeysCategories.map((category, idx) => {
