...
import { idorSteps } from "@/lib/waf-idors-data"
import {
  ExternalLink,
  Lightbulb,
  Wrench,
...
export default function IDORPage() {
  ...
  const totalCommands = idorSteps.reduce(
