...
import {
  shodanDorksCategories,
  shodanDorksTools,
} from "@/lib/shodan-dorks-data"
import {
  Search,
  Terminal,
  ChevronRight,
...
export default function ShodanDorksPage() {
  const [activeCategory, setActiveCategory] = useState("basic-filters")
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="lg:pl-64">
        ...
        <div className="border-b border-border bg-card/50">
          <div className="mx-auto max-w-5xl px-6 py-3">
            <nav className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <ChevronRight className="h-4 w-4" />
              <span className="text-foreground">Shodan Dorks</span>
            </nav>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl space-y-12 p-6">
          {shodanDorksCategories.map((category, idx) => {
