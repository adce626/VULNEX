...
import { automationChapters } from "@/lib/automation-data"
import { Target, Copy, Check, Zap, ChevronRight, ExternalLink } from "lucide-react"
...
export default function AutomationPage() {
  const [activeChapter, setActiveChapter] = useState(automationChapters[0].id)
  ...
  return (
    <div className="bug-bounty-realm">
      <PageTitle title="Automation Setup — Bug Bounty Pipeline Guide" />
      ...
      <section className="relative overflow-hidden border-b px-6 pt-16 pb-12 text-center" style={{ borderColor: "var(--bb-border)" }}>
        ...
        <div className="relative mx-auto max-w-4xl">
          <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl" style={{ background: "var(--bb-primary-glow)", border: "1px solid var(--bb-primary)" }}>
            <Zap className="h-8 w-8" style={{ color: "var(--bb-primary)" }} />
          </div>
      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        {automationChapters.map((chapter) => (
