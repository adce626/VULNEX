...
const toolTypeMap: Record<string, { label: string; color: string }> = {
  ...
  assetfinder: { label: "Discovery", color: "bg-indigo-500/15 text-indigo-400 border-indigo-500/30" },
  findomain: { label: "Discovery", color: "bg-indigo-500/15 text-indigo-400 border-indigo-500/30" },
  chaos: { label: "Enumeration", color: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30" },
  githubsubdomains: { label: "Discovery", color: "bg-indigo-500/15 text-indigo-400 border-indigo-500/30" },
  crobat: { label: "Enumeration", color: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30" },
  sublist3r: { label: "Enumeration", color: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30" },
  oneforall: { label: "Enumeration", color: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30" },
  dnsx: { label: "DNS", color: "bg-sky-500/15 text-sky-400 border-sky-500/30" },
  shuffledns: { label: "DNS", color: "bg-sky-500/15 text-sky-400 border-sky-500/30" },
  massdns: { label: "DNS", color: "bg-sky-500/15 text-sky-400 border-sky-500/30" },
  puredns: { label: "DNS", color: "bg-sky-500/15 text-sky-400 border-sky-500/30" },
  altdns: { label: "Generator", color: "bg-teal-500/15 text-teal-400 border-teal-500/30" },
  dnsgen: { label: "Generator", color: "bg-teal-500/15 text-teal-400 border-teal-500/30" },
  hakrevdns: { label: "DNS", color: "bg-sky-500/15 text-sky-400 border-sky-500/30" },
  mapcidr: { label: "Network", color: "bg-sky-500/15 text-sky-400 border-sky-500/30" },
  tlsx: { label: "Scanner", color: "bg-rose-500/15 text-rose-400 border-rose-500/30" },
  rustscan: { label: "Scanner", color: "bg-rose-500/15 text-rose-400 border-rose-500/30" },
  autorecon: { label: "Scanner", color: "bg-rose-500/15 text-rose-400 border-rose-500/30" },
  unicornscan: { label: "Scanner", color: "bg-rose-500/15 text-rose-400 border-rose-500/30" },
  zmap: { label: "Scanner", color: "bg-rose-500/15 text-rose-400 border-rose-500/30" },
  smap: { label: "Scanner", color: "bg-rose-500/15 text-rose-400 border-rose-500/30" },
  feroxbuster: { label: "Brute-Forcer", color: "bg-pink-500/15 text-pink-400 border-pink-500/30" },
  wfuzz: { label: "Fuzzing", color: "bg-yellow-500/15 text-yellow-400 border-yellow-500/30" },
  waybackurls: { label: "Collection", color: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30" },
  gauplus: { label: "Collection", color: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30" },
  uro: { label: "Analysis", color: "bg-amber-500/15 text-amber-400 border-amber-500/30" },
  hakrawler: { label: "Crawler", color: "bg-green-500/15 text-green-400 border-green-500/30" },
  xnlinkfinder: { label: "Discovery", color: "bg-indigo-500/15 text-indigo-400 border-indigo-500/30" },
  parameth: { label: "Discovery", color: "bg-indigo-500/15 text-indigo-400 border-indigo-500/30" },
  qsreplace: { label: "Analysis", color: "bg-amber-500/15 text-amber-400 border-amber-500/30" },
  uniscan: { label: "Scanner", color: "bg-rose-500/15 text-rose-400 border-rose-500/30" },
  kxss: { label: "Scanner", color: "bg-rose-500/15 text-rose-400 border-rose-500/30" },
  gxss: { label: "Scanner", color: "bg-rose-500/15 text-rose-400 border-rose-500/30" },
  secretfinder: { label: "Discovery", color: "bg-indigo-500/15 text-indigo-400 border-indigo-500/30" },
  linkfinder: { label: "Discovery", color: "bg-indigo-500/15 text-indigo-400 border-indigo-500/30" },
  jsparser: { label: "Analysis", color: "bg-amber-500/15 text-amber-400 border-amber-500/30" },
  getjs: { label: "Collection", color: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30" },
  subjs: { label: "Collection", color: "bg-emerald-500/15 text-emerald-400 border-emerald-500/30" },
  mantra: { label: "Analysis", color: "bg-amber-500/15 text-amber-400 border-amber-500/30" },
  jsluice: { label: "Analysis", color: "bg-amber-500/15 text-amber-400 border-amber-500/30" },
  aquatone: { label: "Screenshot", color: "bg-violet-500/15 text-violet-400 border-violet-500/30" },
  gowitness: { label: "Screenshot", color: "bg-violet-500/15 text-violet-400 border-violet-500/30" },
  eyewitness: { label: "Screenshot", color: "bg-violet-500/15 text-violet-400 border-violet-500/30" },
  webscreenshot: { label: "Screenshot", color: "bg-violet-500/15 text-violet-400 border-violet-500/30" },
  witnessme: { label: "Screenshot", color: "bg-violet-500/15 text-violet-400 border-violet-500/30" },
  webanalyze: { label: "Fingerprinting", color: "bg-teal-500/15 text-teal-400 border-teal-500/30" },
  wafw00f: { label: "Fingerprinting", color: "bg-teal-500/15 text-teal-400 border-teal-500/30" },
  s3scanner: { label: "Cloud", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
  lazys3: { label: "Cloud", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
  cloudenum: { label: "Cloud", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
  awsbucketdump: { label: "Cloud", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
  festin: { label: "Cloud", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
  gcpbucketbrute: { label: "Cloud", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
  grayhatwarfare: { label: "Cloud", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
  enumerateiam: { label: "Cloud", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
  scoutsuite: { label: "Cloud", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
  pacu: { label: "Cloud", color: "bg-cyan-500/15 text-cyan-400 border-cyan-500/30" },
  mitmproxy: { label: "Proxy", color: "bg-purple-500/15 text-purple-400 border-purple-500/30" },
  proxify: { label: "Proxy", color: "bg-purple-500/15 text-purple-400 border-purple-500/30" },
  "recon-ng": { label: "Framework", color: "bg-orange-500/15 text-orange-400 border-orange-500/30" },
  spiderfoot: { label: "OSINT", color: "bg-blue-500/15 text-blue-400 border-blue-500/30" },
  photon: { label: "Crawler", color: "bg-green-500/15 text-green-400 border-green-500/30" },
  gitleaks: { label: "Scanner", color: "bg-rose-500/15 text-rose-400 border-rose-500/30" },
  holehe: { label: "OSINT", color: "bg-blue-500/15 text-blue-400 border-blue-500/30" },
  maigret: { label: "OSINT", color: "bg-blue-500/15 text-blue-400 border-blue-500/30" },
  intelx: { label: "OSINT", color: "bg-blue-500/15 text-blue-400 border-blue-500/30" },
  maltego: { label: "OSINT", color: "bg-blue-500/15 text-blue-400 border-blue-500/30" },
}
...
const difficultyMap: Record<string, { level: string; bars: number; color: string }> = {
  ...
  assetfinder: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  findomain: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  chaos: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  githubsubdomains: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  crobat: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  sublist3r: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  oneforall: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  dnsx: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  shuffledns: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  massdns: { level: "Advanced", bars: 3, color: "bg-red-500" },
  puredns: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  altdns: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  dnsgen: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  hakrevdns: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  mapcidr: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  tlsx: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  rustscan: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  autorecon: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  unicornscan: { level: "Advanced", bars: 3, color: "bg-red-500" },
  zmap: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  smap: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  feroxbuster: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  wfuzz: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  waybackurls: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  gauplus: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  uro: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  hakrawler: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  xnlinkfinder: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  parameth: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  qsreplace: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  uniscan: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  kxss: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  gxss: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  secretfinder: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  linkfinder: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  jsparser: { level: "Advanced", bars: 3, color: "bg-red-500" },
  getjs: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  subjs: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  mantra: { level: "Advanced", bars: 3, color: "bg-red-500" },
  jsluice: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  aquatone: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  gowitness: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  eyewitness: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  webscreenshot: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  witnessme: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  webanalyze: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  wafw00f: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  s3scanner: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  lazys3: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  cloudenum: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  awsbucketdump: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  festin: { level: "Advanced", bars: 3, color: "bg-red-500" },
  gcpbucketbrute: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  grayhatwarfare: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  enumerateiam: { level: "Advanced", bars: 3, color: "bg-red-500" },
  scoutsuite: { level: "Advanced", bars: 3, color: "bg-red-500" },
  pacu: { level: "Advanced", bars: 3, color: "bg-red-500" },
  mitmproxy: { level: "Advanced", bars: 3, color: "bg-red-500" },
  proxify: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  "recon-ng": { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  spiderfoot: { level: "Advanced", bars: 3, color: "bg-red-500" },
  photon: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  gitleaks: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  holehe: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  maigret: { level: "Beginner", bars: 1, color: "bg-emerald-500" },
  intelx: { level: "Intermediate", bars: 2, color: "bg-yellow-500" },
  maltego: { level: "Advanced", bars: 3, color: "bg-red-500" },
}
