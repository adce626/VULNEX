...
import { arjunCategories, arjunTools } from "@/lib/arjun-data"
import {
  Search,
  Terminal,
  ChevronRight,
...
export default function ArjunPage() {
  ...
  const totalCommands = arjunCategories.reduce(
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="lg:pl-64">
        ...
        <div className="relative overflow-hidden border-b border-border bg-gradient-to-br from-primary/10 via-background to-accent/5">
          <div className="relative px-6 py-12 text-center lg:py-16">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-muted-foreground text-pretty">
              Discover hidden HTTP parameters using intelligent brute-forcing. Arjun automatically identifies API parameters without needing a wordlist.
            </p>
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
              <span className="rounded-full bg-primary/10 px-4 py-2 text-sm font-medium text-primary">
                {arjunCategories.length} Categories
              </span>
              ...
              <UsageGuide guide={getToolById('arjun')!} />
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl space-y-12 p-6">
          {arjunCategories.map((category, idx) => {
            ...
            return (
              <section key={idx} id={sectionId} className="scroll-mt-20">
                ...
                <CommandList commands={category.commands} pageTitle="Arjun" pageSize={15} />
              </section>
            )
          })}
