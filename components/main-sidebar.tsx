...
const allPages = [
  ...
  { title: "Gospider Methods", href: "/methods/gospider", keywords: "gospider,crawl,spider,recon" },
  { title: "CeWL Wordlists", href: "/methods/cewl", keywords: "cewl,wordlist,password,custom" },
